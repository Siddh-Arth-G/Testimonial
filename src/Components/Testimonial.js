...
function Testimonial(props){
  ...
  return (
    <div className='w-[85vw] md:w-[700px] rounded-md bg-white flex flex-col justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl'>
        ...
        <div onClick={leftShiftHandler} className='flex text-3xl justify-center mt-9 gap-3 text-violet-400 font-bold'>
        ...
        <div className='mt-6'>
          <button onClick={surpriseHandler} className='bg-violet-400 hover:bg-violet-500 transition-all duration-200 cursor-pointer px-10 py-2 rounded-sm font-bold text-white text-lg'>
            Surprise me
          </button>
        </div>
    </div>
